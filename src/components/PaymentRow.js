...
function PaymentRow(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("section", { id: 'payment_row', children: [(0, jsx_runtime_1.jsx)("div", { id: 'row_date', children: props.correctDate }), (0, jsx_runtime_1.jsx)("input", { id: 'row_file_name', value: fileName, onChange: (e) => setFileName(e.target.value) }), (0, jsx_runtime_1.jsx)("input", { id: 'row_word_count', type: "number", value: wordCount, onChange: (e) => setWordCount(parseInt(e.target.value)) }), (0, jsx_runtime_1.jsx)("input", { id: 'row_proofreader', value: proofreader, onChange: (e) => setProofreader(e.target.value) })] }), (0, jsx_runtime_1.jsx)("button", { onClick: handleClick, children: "Send File" })] }));
}
